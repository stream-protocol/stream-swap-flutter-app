...
class _OrderbookState extends State<Orderbook> {
  ...
  String dropdownvalue2 = "STR - USDC";
  String dropAddress = "5P3giWpPBrVKL8QP8roKM7NsLdi3ie1Nc2b5r9mGtvwb";
  var items = ['ALL', 'ASKS', 'BIDS'];
  var items2 = ["SOl - USDC", "STR - USDC", "BTC - USDC", "SRM - USDC"];

  var address = {
    "SOl - USDC": "9wFFyRfZBsuAha4YcuxcXLKwMxJR43S7fPfQLusDBzvT",
    "STR - USDC": "5P3giWpPBrVKL8QP8roKM7NsLdi3ie1Nc2b5r9mGtvwb",
